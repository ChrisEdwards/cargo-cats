...
class CustomUserDetailsServiceSecurityTest {
    ...
    @Test
    void testLoadUserByUsername_WithSpecialCharacters_ShouldNotThrowException() {
        ...
        UserDetails userDetails = customUserDetailsService.loadUserByUsername(usernameWithSpecialChars);
