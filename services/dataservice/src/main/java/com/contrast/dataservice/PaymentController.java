    ...
    public List<Map<String, Object>> executeRawQuery(
        ...
        try {
            ...
            if (creditCard != null && !creditCard.isEmpty() && shipmentId != null && !shipmentId.isEmpty()) {
                ...
                String lastFourDigits = creditCard.length() > 4 ? creditCard.substring(creditCard.length() - 4) : creditCard;
                ...
                jdbcTemplate.update(updateSql, "XXXX-XXXX-XXXX-" + lastFourDigits, shipmentId);
